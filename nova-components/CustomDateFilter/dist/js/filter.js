...
Nova.booting(function (Vue, router, store) {
  Vue.component('custom-date-filter', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    change1: function change1(event) {
      this.values[0] = event.target.value;
      this.handleChange();
    },
    change2: function change2(event) {
    ...
    _c("div", { staticClass: "p-2" }, [
      ...
      _c("div", { staticClass: "w-full mb-3" }, [
        ...
        _c("input", {
          ref: "datePicker",
          staticClass: "w-full form-control form-input form-input-bordered",
          attrs: { type: "date", placeholder: "End Date", name: "end_date" },
